...
["The world would be a better place if more engineers, like me, hated technology. The stuff I design, if I’m successful, nobody will ever notice. Things will just work, and be self-managing.,", "Radia Pearlman"]];
    ...
    const tweetQuote = "https://twitter.com/intent/tweet?text=" + answer + " - " + author;
    return (
      <div>
...
function (_React$Component) {
  ...
  _createClass(QuoteGenerator, [{
    ...
    value: function render() {
      ...
      var tweetQuote = "https://twitter.com/intent/tweet?text=" + answer + " - " + author;
      return React.createElement("div", null, React.createElement("button", {
        onClick: this.ask
      }, "Get a random quote"), React.createElement("br", null), React.createElement("h3", null, "Quote"), React.createElement("p", null, answer, React.createElement("br", null), "- ", author), React.createElement("a", {
        href: tweetQuote
      }, "Tweet Quote"));
    }
  }]);
